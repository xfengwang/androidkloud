...
public class ChangeGroupNameActivity extends Activity {
	...
	private void JudgeIsUpdate() {
		...
		if(null == name || name.length() < 1){
			Toast.makeText(getApplicationContext(), getResources().getString(R.string.group_name_cannot_be_empty),
	...
	private void UpdateGroupNameSuccess() {
		...
		GroupMessage gmsg = new GroupMessage(AppConfig.UserName + getResources().getString(R.string.group_name_modified));
		RongIM.getInstance()
		.getRongIMClient()
