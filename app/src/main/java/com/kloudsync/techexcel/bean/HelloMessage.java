...
public class HelloMessage {
	...
	public int getDocumentListChangeNumber() {
		return documentListChangeNumber;
	}

	public void setDocumentListChangeNumber(int documentListChangeNumber) {
		this.documentListChangeNumber = documentListChangeNumber;
	}
    ...
    public String toString() {
        return "HelloMessage{" +
		        ...
		        ", documentListChangeNumber=" + documentListChangeNumber +
                '}';
    }
}
