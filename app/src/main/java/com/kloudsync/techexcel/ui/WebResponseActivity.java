...
public class WebResponseActivity extends Activity{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getIntent() != null){
            ...
            text.setText(getResources().getString(R.string.notes_opened_by_schema)+"\n"+
                    "url="+url+"\n" + "noteId=" + noteId);
        ...
        if (TextUtils.isEmpty(noteId)) {
            ...
            if (!QueryLocalNoteTool.noteIsExist(this, noteId)) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WebResponseActivity.this, getResources().getString(R.string.note_not_exist), Toast.LENGTH_SHORT).show();
                    }
                });
                return;
            }
