...
//        intent.putExtra("meeting_id", "Doc-" + AppConfig.UserID);
    ...
    private void initView(View view) {
        ll_space = (LinearLayout) view.findViewById(R.id.ll_space);
        ...
        teamSpaceDocumentAdapter = new HomeDocumentAdapter(getActivity(), documentList);
                ...
                pd.setPoPMoreListener(new PopDocument.PopDocumentListener() {
                    ...
                    public void PopDelete() {
                        ...
                        if (role == 7 || role == 8 || teamRole == RoleInTeam.ROLE_OWENER || teamRole == RoleInTeam.ROLE_ADMIN) {
                            ...
                            Toast.makeText(getActivity(),getResources().getString(R.string.no_permissions_to_delete),Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    public void getTeamItem() {
        ...
        TeamSpaceInterfaceTools.getinstance().getTeamItem(AppConfig.URL_PUBLIC + "TeamSpace/Item?itemID=" + spaceId, TeamSpaceInterfaceTools.GETTEAMITEM, new TeamSpaceInterfaceListener() {
            ...
            public void getServiceReturnData(Object object) {
                ...
                spaceName=teamSpaceBean.getName();
                refreshSpaceLayout(true,null);
                getSpaceList();
            }
        });
...
//                uploadFile(file, spaceId);
        ...
        }else if(requestCode==REQUEST_SWITCH_TEAM&&resultCode==SwitchTeamActivity.RESULT_SWITCH){
            getAllDocumentList(data.getIntExtra("teamid",0));
            getSpaceList(data.getIntExtra("teamid",0));
            projectText.setText(data.getStringExtra("name"));
        }
    }
...
//                finish();
            ...
            case R.id.search_layout:
                ...
                startActivity(intent);
                break;
            case R.id.ll_team_switch:
                Intent i=new Intent(getActivity(),SwitchTeamActivity.class);
                i.putExtra("FromSpace",true);
                startActivityForResult(i,REQUEST_SWITCH_TEAM);
                break;
        }
    ...
    private void showMoreDialog(ImageView ivMore) {
        ...
        teamMorePopup.getPopwindow(getActivity(),sharedPreferences.getInt("Role",0));
...
//                finish();
            ...
            public void createNewSpace() {
                Intent intent=new Intent(getActivity(), CreateNewSpaceActivityV2.class);
...
//                context.startForegroundService(service);
        ...
        TeamSpaceInterfaceTools.getinstance().getSpaceDocumentList(AppConfig.URL_PUBLIC + "SpaceAttachment/List?spaceID=" + spaceId + "&type=1&pageIndex=0&pageSize=100&searchText=",
                TeamSpaceInterfaceTools.GETSPACEDOCUMENTLIST, new TeamSpaceInterfaceListener() {
                    ...
                    public void getServiceReturnData(Object object) {
                        ...
                        teamSpaceDocumentAdapter.notifyDataSetChanged();
                    }
                });
    }

    private void getAllDocumentList(int teamId) {
        ServiceInterfaceTools.getinstance().getAllDocumentList(teamId + "").enqueue(new Callback<NetworkResponse<DocumentData>>() {
            @Override
    ...
    private void getSpaceList(int teamId) {
        ...
        TeamSpaceInterfaceTools.getinstance().getTeamSpaceList(url,
                TeamSpaceInterfaceTools.GET_SPACE_LIST_IN_HOME_PAGE, new TeamSpaceInterfaceListener() {
                    ...
                    public void getServiceReturnData(Object object) {
                        ...
                        refreshSpaceLayout(false,list);
                    }
                });
    }

    private void refreshSpaceLayout(boolean isFirst,List<TeamSpaceBean> list){
        ll_space.removeAllViews();
        Log.e("event_bus-----", isFirst+"");
        if(!isFirst){
            for(int i=0;i<list.size();i++){
                View view=getLayoutInflater().inflate(R.layout.item_space,null);
                TextView tv_item_space_document=view.findViewById(R.id.tv_item_space_document);
                LinearLayout ll_item_space=view.findViewById(R.id.ll_item_space);
                final ImageView iv_item_space_more=view.findViewById(R.id.iv_item_space_more);
                iv_item_space_more.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        showMoreDialog(iv_item_space_more);
                    }
                });
                tv_item_space_document.setText(list.get(i).getName());
                Log.e("event_bus-----", list.get(i).getName());
                ll_item_space.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        GoToSwitch();
                    }
                });
                ll_space.addView(view);
            }
        }else {
            View view=getLayoutInflater().inflate(R.layout.item_space,null);
            TextView tv_item_space_document=view.findViewById(R.id.tv_item_space_document);
            ...
            tv_item_space_document.setText(spaceName);
            ll_item_space.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    GoToSwitch();
