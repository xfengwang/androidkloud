...
//                                        GoToVIew(lesson);
                                    ...
                                    public void PopDelete() {
                                        ...
                                        if (role == 7 || role == 8 || teamRole == RoleInTeam.ROLE_OWENER || teamRole == RoleInTeam.ROLE_ADMIN) {
                                            ...
                                            Toast.makeText(getActivity(),getResources().getString(R.string.no_permission_to_delete),Toast.LENGTH_LONG).show();
                                        }
...
//                                    requestDocumentDetail(document);
    ...
    private void initView(View view) {
        ...
        tv_doc_new_space = (TextView) view.findViewById(R.id.tv_doc_new_space);
        ...
        tv_doc_new_space.setOnClickListener(this);
    ...
    private void getTeam() {
        ...
        if (teamId == 0) {
            tv_doc_new_space.setVisibility(View.GONE);
        } else {
            tv_doc_new_space.setVisibility(View.VISIBLE);
        }
...
//                AddBiuBiu();
                ...
                break;
            case R.id.tv_doc_new_space:
//                Intent intent3 = new Intent(getActivity(), tv_doc_new_spaceActivityV2.class);
...
//                    CreateFolderDialog.instance(getActivity()).setCreateFolderCallback(this);
    ...
    public void createFolder(String folderName) {
        TeamSpaceInterfaceTools.getinstance().createTeamSpace(AppConfig.URL_PUBLIC + "TeamSpace/CreateTeamSpace", TeamSpaceInterfaceTools.CREATETEAMSPACE,0,0,
...
//                GoToRename();
            ...
            public void createNewSpace() {
                Intent intent=new Intent(getActivity(), CreateNewTeamActivityV2.class);
                startActivity(intent);
