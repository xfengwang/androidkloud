...
public class DocAndMeetingFileListPopupwindow implements View.OnClickListener {
	...
	private void initPopupwindow() {
		...
		ll_pop_doc_operate = mView.findViewById(R.id.ll_pop_doc_operate);
		...
		ll_pop_doc_operate.getBackground().setAlpha(204);
	}
	...
	private void saveDocTeamSpace() {
		mSaveDocumentTeamSpaceDialog = new SaveDocumentTeamSpaceDialog(mContext);
		mSaveDocumentTeamSpaceDialog.show();
	}
