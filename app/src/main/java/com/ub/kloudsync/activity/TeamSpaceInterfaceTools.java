...
public class TeamSpaceInterfaceTools {
     ...
     * 创建Team或者Space
     */
    public void createTeamSpace(final String url, final int code, int access,int accesssame, int companyID, int type, String name, int parentId, int teamType, TeamSpaceInterfaceListener teamSpaceInterfaceListener) {
        putInterface(code, teamSpaceInterfaceListener);
        try {
            final JSONObject jsonObject = new JSONObject();
            jsonObject.put("Access", access);
            jsonObject.put("AccessSame", accesssame);
