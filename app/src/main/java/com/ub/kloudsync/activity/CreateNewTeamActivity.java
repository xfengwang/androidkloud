...
public class CreateNewTeamActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if(isSync){
            ...
            teamtypecontent.setText(getResources().getString(R.string.no_link_to_document_team));
    ...
    private void openTeamTypePopup() {
        ...
        newTeamTypePopup.setFavoritePoPListener(new NewTeamTypePopup.FavoritePoPListener() {
            ...
            public void select(int type) {
                teamType = type;
                if (type == 1) {
                    teamtypecontent.setText(getResources().getString(R.string.document_team_only));
                } else if (type == 2) {
                    teamtypecontent.setText(getResources().getString(R.string.both_document_team_and_topic_team));
                }
            }
            @Override
            public void dismiss() {
