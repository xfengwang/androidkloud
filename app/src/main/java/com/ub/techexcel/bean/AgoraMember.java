...
public class AgoraMember implements Comparable<AgoraMember>,Serializable {
    ...
    public boolean isCoachingTobeAudience() {
        return isCoachingTobeAudience;
    }

    public void setCoachingTobeAudience(boolean coachingTobeAudience) {
        isCoachingTobeAudience = coachingTobeAudience;
    }

    public boolean isCoachingStudent() {
        return isCoachingStudent;
    }

    public void setCoachingStudent(boolean coachingStudent) {
        isCoachingStudent = coachingStudent;
    }

    public boolean isCoachingAudience() {
        return isCoachingAudience;
    }

    public void setCoachingAudience(boolean coachingAudience) {
        isCoachingAudience = coachingAudience;
    }

    public boolean isSelectedCoach() {
        return isSelectedCoach;
    }

    public void setSelectedCoach(boolean selectedCoach) {
        isSelectedCoach = selectedCoach;
    }
