...
public class ServiceAdapter2 extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) holder.rv_attendee.getLayoutParams();
        if(attendees.size()>0){
            holder.rv_attendee.setAdapter(new AttendeeAdapter(context,attendees));
            holder.tv_persons.setText(attendees.size()+"人");
            holder.rv_attendee.setVisibility(View.VISIBLE);
            holder.tv_persons.setVisibility(View.VISIBLE);
            holder.tv_persons.setText(attendees.size()+context.getResources().getString(R.string.person));
            ...
            holder.tv_attendee.setVisibility(View.VISIBLE);
            holder.tv_attendee.setText(context.getResources().getString(R.string.no_participants));
        }
        holder.rv_attendee.setLayoutParams(layoutParams);
        return convertView;
    }
