...
public class LessionAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.date.setText(start + " - " + end + "(" + dd + ")");

        String names[]=lession.getTeacherNames().split(",");
        String name="";
        ...
        if(TextUtil.isEmpty(lession.getStudentNames())){
            holder.attendee.setText(context.getResources().getString(R.string.no_student));
            holder.label.setVisibility(View.GONE);
        }else {
            holder.attendee.setText(context.getResources().getString(R.string.student)+"：" + lession.getStudentNames());
        }
    ...
    class ViewHolder {
        TextView day, month, title, date, host, attendee,label;
