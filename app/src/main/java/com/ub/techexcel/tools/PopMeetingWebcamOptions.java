...
public class PopMeetingWebcamOptions implements View.OnClickListener {
    ...
    private View view;
    private RelativeLayout oneLayout, twoLayout, threeLayout, fourLayout,layout_one_coach;
    ...
    public void initPopuptWindow() {
        ...
        layout_one_coach = (RelativeLayout) view.findViewById(R.id.layout_one_coach);
        ...
        layout_one_coach.setOnClickListener(this);
        ...
        if (meetingConfig.isMeetingPause()) {
            if (meetingConfig.isCoaching()) {
                if(meetingConfig.meIsCoachingMember()){
                    if(!meetingConfig.getPresenterId().equals(AppConfig.UserID)){
                        layout_one_coach.setVisibility(View.VISIBLE);
                    }else{
                        layout_one_coach.setVisibility(View.GONE);
                    }
                }else{
                    layout_one_coach.setVisibility(View.GONE);
                }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.layout_four:
                ...
                break;
            case R.id.layout_one_coach:
                PrivateCoachManager.getManager(mContext).leavePrivateCoaching();
                dismiss();
                break;
            default:
                break;
